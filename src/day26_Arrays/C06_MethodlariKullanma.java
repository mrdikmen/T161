...
public class C06_MethodlariKullanma {
    ...
    public static void main(String[] args) {
        ...
        arr = day26_arrays.C02_ArrayeKaliciOlarakBirElemanEkleme.arrayeElemanEkle(arr,9);

        System.out.println(Arrays.toString(arr)); //  [5, 8, 1, 3, 9]

        // 6.eleman olarak 4 ekleyin

        arr = day26_arrays.C02_ArrayeKaliciOlarakBirElemanEkleme.arrayeElemanEkle(arr,4);
