...
public class C03_EnUzunKelime {
    ...
    public static void enUzunIsmiYazdir(){
        ...
        System.out.println("Girilen En Uzun Isım: " + enUzunIsim);
    }


    //ayni gorevi yapip
    //en sonda en uzun ismi yazdirmak yerine donduren bir method olusturun

    public static String enUzunIsmiDondur(){
        Scanner scanner = new Scanner(System.in);
        ...
        while (!girilenIsim.equalsIgnoreCase("q")){
            ...
            if (girilenIsim.length()>enUzunIsım.length()){
                enUzunIsım=girilenIsim;
            }
